...
description: >
  ...
  collage) — the same aesthetic VKEN Design Engine uses for its own marketing
...
sibling [`vken-landing-deck`](../vken-landing-deck/) skill)
...
This is the canonical VKEN Design Engine marketing-page recipe — the example
...
worked example (VKEN Design Engine itself).
...
├── inputs.example.json      # VKEN Design Engine as the worked example
...
└── assets/
    ├── *.png                # 16 collage plates (VKEN Design Engine instance)
...
- [`skills/vken-landing-deck/`](../vken-landing-deck/) — sibling slides skill that reuses this design system.
