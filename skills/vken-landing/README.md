...
- **Path:** `skills/editorial-collage/` → `skills/vken-landing/`.
- **Shared assets:** downstream paths such as `../editorial-collage/assets/`
  (for example from the slide-deck skill) should use
  [`../vken-landing/assets/`](./assets/) — see
  [`vken-landing-deck`](../vken-landing-deck/README.md).
...
- [`skills/vken-landing-deck/`](../vken-landing-deck/) — sibling skill that produces a slide deck in the same visual language.
