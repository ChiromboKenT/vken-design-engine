...
> **VKEN Design Engine integration.** This is the unmodified Codex `hatch-pet` skill,
> vendored under `skills/hatch-pet/` so any VKEN Design Engine agent can run it. After
