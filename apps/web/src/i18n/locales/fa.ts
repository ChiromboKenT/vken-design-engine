...
export const fa: Dict = {
  ...
  'settings.welcomeTitle': 'VKEN Design Engine را راه‌اندازی کنید',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه VKEN Design Engine — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه VKEN Design Engine ارائه می‌شود — نیازی به دانلود نیست.',
