...
export const hu: Dict = {
  ...
  'settings.welcomeTitle': 'VKEN Design Engine beállítása',
  ...
  'pet.tabBuiltInHint': 'Az VKEN Design Enginenal csomagolt társak — válassz egyet és fogadd örökbe.',
  ...
  'pet.codexBundledTitle': 'Az VKEN Design Enginegal érkezik — letöltés nem szükséges.',
