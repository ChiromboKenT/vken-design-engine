...
export const uk: Dict = {
  ...
  'settings.welcomeTitle': 'Налаштування VKEN Design Engine',
  ...
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з VKEN Design Engine — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з VKEN Design Engine — завантаження не потрібне.',
