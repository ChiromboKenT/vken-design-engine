...
export const ru: Dict = {
  ...
  'settings.welcomeTitle': 'Настройте VKEN Design Engine',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте VKEN Design Engine — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с VKEN Design Engine — загрузка не нужна.',
