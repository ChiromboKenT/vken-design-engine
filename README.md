...
> **Agentic design verification and auto-repair for frontends.** VKEN Design Engine builds on the Open Design runtime: local-first, web-deployable, BYOK at every layer, with coding-agent CLIs on your `PATH` becoming the design engine behind verification, critique, and repair loops.

<p align="center">
  <img src="docs/assets/banner.png" alt="VKEN Design Engine editorial cover" width="100%" />
</p>

<p align="center">
  <a href="https://github.com/YOUR_GITHUB_OWNER/vken-design-engine/stargazers"><img alt="Stars" src="https://img.shields.io/github/stars/YOUR_GITHUB_OWNER/vken-design-engine?style=for-the-badge&labelColor=0d1117&color=ffd700&logo=github&logoColor=white" /></a>
  <a href="https://github.com/YOUR_GITHUB_OWNER/vken-design-engine/network/members"><img alt="Forks" src="https://img.shields.io/github/forks/YOUR_GITHUB_OWNER/vken-design-engine?style=for-the-badge&labelColor=0d1117&color=2ecc71&logo=github&logoColor=white" /></a>
  <a href="https://github.com/YOUR_GITHUB_OWNER/vken-design-engine/issues"><img alt="Issues" src="https://img.shields.io/github/issues/YOUR_GITHUB_OWNER/vken-design-engine?style=for-the-badge&labelColor=0d1117&color=ff6b6b&logo=github&logoColor=white" /></a>
  <a href="https://github.com/YOUR_GITHUB_OWNER/vken-design-engine/pulls"><img alt="Pull Requests" src="https://img.shields.io/github/issues-pr/YOUR_GITHUB_OWNER/vken-design-engine?style=for-the-badge&labelColor=0d1117&color=9b59b6&logo=github&logoColor=white" /></a>
  <a href="https://github.com/YOUR_GITHUB_OWNER/vken-design-engine/graphs/contributors"><img alt="Contributors" src="https://img.shields.io/github/contributors/YOUR_GITHUB_OWNER/vken-design-engine?style=for-the-badge&labelColor=0d1117&color=3498db&logo=github&logoColor=white" /></a>
  <a href="https://github.com/YOUR_GITHUB_OWNER/vken-design-engine/commits/main"><img alt="Commit activity" src="https://img.shields.io/github/commit-activity/m/YOUR_GITHUB_OWNER/vken-design-engine?style=for-the-badge&labelColor=0d1117&color=e67e22&logo=git&logoColor=white" /></a>
  <a href="https://github.com/YOUR_GITHUB_OWNER/vken-design-engine/commits/main"><img alt="Last commit" src="https://img.shields.io/github/last-commit/YOUR_GITHUB_OWNER/vken-design-engine?style=for-the-badge&labelColor=0d1117&color=8e44ad&logo=git&logoColor=white" /></a>
</p>

<p align="center">
  <a href="https://github.com/YOUR_GITHUB_OWNER/vken-design-engine/releases/latest"><img alt="Latest release" src="https://img.shields.io/github/v/release/YOUR_GITHUB_OWNER/vken-design-engine?style=flat-square&color=blueviolet&label=release&include_prereleases" /></a>
...
**VKEN Design Engine is the VKEN-facing fork of Open Design.** Same artifact-first mental model, extended toward visual verification, UX critique, and auto-repair for frontend work. The strongest coding agents already live on your laptop; VKEN wires them into a skill-driven design workflow that runs locally with `pnpm tools-dev`, can deploy the web layer to Vercel, and stays BYOK at every layer.
...
```bash
git clone https://github.com/YOUR_GITHUB_OWNER/vken-design-engine.git
cd vken-design-engine
corepack enable
...
<p align="center">
  <a href="https://github.com/YOUR_GITHUB_OWNER/vken-design-engine"><img src="docs/assets/star-us.png" alt="Star VKEN Design Engine on GitHub — github.com/YOUR_GITHUB_OWNER/vken-design-engine" width="100%" /></a>
</p>

If this saved you thirty minutes — give it a ★. Stars don't pay rent, but they tell the next designer, agent, and contributor that this experiment is worth their attention. One click, three seconds, real signal: [github.com/YOUR_GITHUB_OWNER/vken-design-engine](https://github.com/YOUR_GITHUB_OWNER/vken-design-engine).
...
<a href="https://github.com/YOUR_GITHUB_OWNER/vken-design-engine/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=YOUR_GITHUB_OWNER/vken-design-engine&cache_bust=2026-09-19" alt="VKEN Design Engine contributors" />
</a>
...
<a href="https://star-history.com/#YOUR_GITHUB_OWNER/vken-design-engine&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=YOUR_GITHUB_OWNER/vken-design-engine&type=Date&theme=dark&cache_bust=2026-09-19" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=YOUR_GITHUB_OWNER/vken-design-engine&type=Date&cache_bust=2026-09-19" />
    <img alt="VKEN Design Engine star history" src="https://api.star-history.com/svg?repos=YOUR_GITHUB_OWNER/vken-design-engine&type=Date&cache_bust=2026-09-19" />
  </picture>
</a>
